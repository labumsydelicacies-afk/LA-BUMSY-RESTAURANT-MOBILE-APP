...
export default function FoodDetail() {
  ...
  return (
    <main className="page-wrapper bg-gray-50/30">
      ...
      <section className="mx-auto w-full max-w-lg px-3 pb-28 pt-3 fade-up sm:px-4 sm:pt-4">
        <button 
          onClick={() => navigate(-1)}
          className="mb-3 flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-gray-900 transition-colors sm:mb-4"
        >
        ...
        {loading ? (
          <div className="rounded-3xl bg-white p-4 shadow-[0_8px_30px_rgba(0,0,0,0.04)] animate-pulse border border-gray-100 sm:p-5">
          ...
          <div className="overflow-hidden rounded-3xl bg-white shadow-[0_12px_40px_rgba(0,0,0,0.06)] border border-gray-100 relative sm:rounded-[2.5rem]">
            <div className="relative h-64 w-full bg-brandCream overflow-hidden sm:h-72">
              {food.image_url ? (
                <img
            ...
            <div className="p-5 relative sm:p-8">
              {/* Floating Price Tag */}
              <div className="absolute -top-7 right-5 rounded-2xl bg-white p-2 shadow-xl shadow-black/5 border border-gray-100 sm:right-8">
              ...
              <div className="mt-2 pr-20">
                <h2 className="font-heading text-2xl font-black leading-tight text-gray-900 sm:text-3xl">
                  {food.name}
                </h2>
              </div>
